//TTGO ESP32 Display :1.14 inch color LCD 135x240 display
//https://en.wikipedia.org/wiki/Boids
//https://wiki.edu.vn/wiki29/2021/11/17/beflockung-verhalten-wikipedia/

/*
iiypp3 loteqo VEBTXI
...
#include <WiFi.h>
#include <NTPClient.h>
const char* ssid = "xxxxxxxxxxxxxxxxxxx";         // Replace with your
const char* password = "xxxxxxxxxxxxxxx";  // WiFi credentials
WiFiUDP ntpUDP;
...
void loop() {
  ...
  if (timeClient.isTimeSet()) {
    spr.drawString(timeClient.getFormattedTime(), 15, 40, 6);
    spr.drawString(getFormattedDate(), 50, 85, 4);
  }
#endif  //WITH_TIME
